...
class TestInput(unittest.TestCase):        
    ...
    def test_incorrect_track_name(self):
        ...
        expected = (" The song you're looking for is not present in our database. " +
                    " Here you are some recommended songs we have:\n " +
                    " 'Party Rock Anthem',\n " +
                    " 'Symphony Of Destruction',\n " +
                    " 'Some Nights'! ")

        a = Song("My Bodi", "spotify_songs.csv")
        c = Song("99", "spotify_songs.csv")
        b = a.getinfo()
        d = c.getinfo()
    ...
    def test_incorrect_artist_name(self):
        ...
        expected = (" The artist you're looking for is not present in our database. "+
                  " Here you are some recommended artist we have:\n " + 
                  " 'Mariah Carey',\n " +
                  " 'Madison Beer',\n " +
                  " 'GASHI'! ")
        
        a = Artist("Maria Carey", "spotify_songs.csv")
        c = Artist("85", "spotify_songs.csv")
        b = a.getdiscography()
        d = c.getdiscography()
    ...
    def test_correct_karaoke_song(self):
        ...
        a = Song("Party Rock Anthem", "spotify_songs.csv")
        b = a.karaoke()
    ...
    def test_incorrect_karaoke_song(self):
        ...
        a = Song("Party Rock Antem", "spotify_songs.csv")
        c = Song("85", "spotify_songs.csv")
        b = a.karaoke()
        d = c.karaoke()
    ...
    def test_incorrect_get_song(self):
        ...
        expected = ("So sorry! '" + "push it out, fake smile" + "' seems not to be found in any song inside our database.\n\n"+
                 "You could try with other lyrics, try these for example:\n" +
                 "'Push it out, fake a smile'\n" +
                 "'I just wanna stay in the sun where I find'")
        
        a = Lyrics("Push it out, fake smile", "spotify_songs.csv")
        b = a.getsong()
    ...
    def test_empty_get_song(self):
        ...
        expected = ("Empty input is not supported by the program. Try with something different!")
        
        a = Lyrics(" ", "spotify_songs.csv")
        b = a.getsong()
